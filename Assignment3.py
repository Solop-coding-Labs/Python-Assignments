...
# I. Extract emails
sample_text = "Contact us at Report@example.com or Service@myshop.org for more info."
...
# III. Replace words
original_text = "Tennis is fun. I love Food!"
updated_text = replace_word(original_text, "Food", "Tennis")
print("Updated text:", updated_text)

# IV. Split by non-alphanumeric characters
text_to_split = "Hi, What is up! 123_Lets go."
